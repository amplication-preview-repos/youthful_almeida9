...
@InputType()
class AssignmentCreateNestedManyWithoutPropertiesInput {
...
export { AssignmentCreateNestedManyWithoutPropertiesInput as AssignmentCreateNestedManyWithoutPropertiesInput };
